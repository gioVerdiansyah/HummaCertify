...
var options, chart, chartDonutBasicColors = getChartColorsArray("simple_dount_chart"),
    url = (chartDonutBasicColors && (options = { series: [98, 63, 35], labels: ["New Application", "Approved", "Rejected"], chart: { height: 300, type: "donut" }, legend: { position: "bottom" }, dataLabels: { dropShadow: { enabled: !1 } }, colors: chartDonutBasicColors }, (chart = new ApexCharts(document.querySelector("#simple_dount_chart"), options)).render()), "assets/json/"),
    allJobList = "",
    editList = !1,
...
getJSON("job-list.json", function(e, t) { null !== e ? console.log("Something went wrong: " + e) : (loadJobListData(allJobList = t, currentPage), paginationEvents(), sortElementsById()) });
var tagInputField = new Choices("#taginput-choices", { removeItemButton: !0 });

function fetchIdFromObj(e) { return parseInt(e.id) }

function findNextId() { var e, t; return 0 === allJobList.length ? 0 : (e = fetchIdFromObj(allJobList[allJobList.length - 1])) <= (t = fetchIdFromObj(allJobList[0])) ? t + 1 : e + 1 }

function sortElementsById() { loadJobListData(allJobList.sort(function(e, t) { e = fetchIdFromObj(e), t = fetchIdFromObj(t); return t < e ? -1 : e < t ? 1 : 0 }), currentPage) }
...
document.querySelector("#companylogo-image-input").addEventListener("change", function() {
        var e = document.querySelector("#companylogo-img"),
            ...
            n = new FileReader;
        n.addEventListener("load", function() { e.src = n.result }, !1), t && n.readAsDataURL(t)
