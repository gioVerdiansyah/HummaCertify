function searchMessages() {
    ...
    document.getElementById("users-conversation").getElementsByTagName("li").forEach(function(e) { t = e.getElementsByTagName("p")[0] ? e.getElementsByTagName("p")[0] : "", -1 < (t.textContent || t.innerText ? t.textContent || t.innerText : "").toUpperCase().indexOf(s) ? e.style.display = "" : e.style.display = "none" })
}! function() {
    ...
    function s() {
        ...
        Array.from(document.querySelectorAll(".chat-user-list li a")).forEach(function(e) {
            e.addEventListener("click", function(e) {
                s.forEach(function(e) { e.classList.add("user-chat-show") });
                var t = document.querySelector(".chat-user-list li.active");
                t && t.classList.remove("active"), this.parentNode.classList.add("active")
            })
        }), document.querySelectorAll(".user-chat-remove").forEach(function(e) { e.addEventListener("click", function(e) { s.forEach(function(e) { e.classList.remove("user-chat-show") }) }) })
    }
    document.querySelectorAll(".favourite-btn").forEach(function(e) { e.addEventListener("click", function(e) { this.classList.toggle("active") }) });
    ...
    function p() { "users" == c ? (document.getElementById("channel-chat").style.display = "none", document.getElementById("users-chat").style.display = "block") : (document.getElementById("channel-chat").style.display = "block", document.getElementById("users-chat").style.display = "none"), t(l + "chats.json") }
    ...
    function t(e) {
        ...
        e = e, t = function(e, t) {
            ...
            null !== e ? console.log("Something went wrong: " + e) : (a = "users" == c ? t[0].chats : t[0].channel_chat, document.getElementById(c + "-conversation").innerHTML = "", r = 0, a.forEach(function(t, e) {
                var s, n;
                0 < r ? r -= 1 : (n = t.from_id == m ? " right" : " left", s = d.find(function(e) { return e.id == t.to_id }), n = '<li class="chat-list' + n + '" id=' + t.id + '>                        <div class="conversation-list">', m != t.from_id && (n += '<div class="chat-avatar"><img src="' + s.profile + '" alt=""></div>'), n = (n += '<div class="user-chat-content">') + u(t.id, t.msg, t.has_images, t.has_files, t.has_dropDown), a[e + 1] && t.from_id == a[e + 1].from_id && (r = function(e, t, s) { for (var n = 0; e[t] && e[t + 1] && e[t + 1].from_id == s;) n++, t++; return n }(a, e, t.from_id), n += function(e, t, s) { for (var n = 0; e[t] && e[t + 1] && e[t + 1].from_id == s;) n = u(e[t + 1].id, e[t + 1].msg, e[t + 1].has_images, e[t + 1].has_files, e[t + 1].has_dropDown), t++; return n }(a, e, t.from_id)), n = n + ('<div class="conversation-name"><span class="d-none name">' + s.name + '</span><small class="text-muted time">' + t.datetime) + '</small> <span class="text-success check-message-icon"><i class="bx bx-check-double"></i></span></div></div>                </div>            </li>', document.getElementById(c + "-conversation").innerHTML += n)
                ...
                t.addEventListener("click", function() {
                    o = !0, s.classList.add("show"), n.addEventListener("click", function() { s.classList.remove("show") });
                ...
                t.addEventListener("click", function() {
                    o = !0, l.classList.add("show"), i.addEventListener("click", function() { l.classList.remove("show") });
                    var e = t.closest(".ctext-wrap").children[0].children[0].innerText,
            ...
            }), document.querySelectorAll(".copy-message").forEach(function(e) { e.addEventListener("click", function() { document.getElementById("copyClipBoard").style.display = "block", document.getElementById("copyClipBoardChannel").style.display = "block", setTimeout(function() { document.getElementById("copyClipBoard").style.display = "none", document.getElementById("copyClipBoardChannel").style.display = "none" }, 1e3) }) }), v("users-chat"), GLightbox({ selector: ".popup-img", title: !1 })
    ...
    e("chat-users-list.json", function(e, t) {
        ...
        var n, a;
        null !== e ? console.log("Something went wrong: " + e) : ((d = t).sort(function(e, t) { return e.name.localeCompare(t.name) }), a = n = "", d.forEach(function(e, t) {
    ...
    f && f.addEventListener("submit", function(e) {
        ...
        var e = a,
            t = a,
            s = g.value;
        0 === s.length ? (h.classList.add("show"), setTimeout(function() { h.classList.remove("show") }, 2e3)) : (1 == o ? (k(t, s), o = !1) : q(e, s), v(e || t)), g.value = "", document.getElementById("close_toggle").click()
    });
    ...
    var q = function(e, t) {
            ...
            n.querySelectorAll(".delete-item").forEach(function(e) { e.addEventListener("click", function() { s.removeChild(n) }) }), n.querySelectorAll(".copy-message").forEach(function(e) {
                e.addEventListener("click", function() {
                    var e = n.childNodes[1].firstElementChild.firstElementChild.firstElementChild.firstElementChild.innerText;
                    navigator.clipboard.writeText(e)
                })
            }), n.querySelectorAll(".copy-message").forEach(function(e) { e.addEventListener("click", function() { document.getElementById("copyClipBoard").style.display = "block", setTimeout(function() { document.getElementById("copyClipBoard").style.display = "none" }, 1e3) }) }), n.querySelectorAll(".reply-message").forEach(function(a) {
                a.addEventListener("click", function() {
                    var e = document.querySelector(".replyCard"),
                        ...
                        t = (o = !0, e.classList.add("show"), t.addEventListener("click", function() { e.classList.remove("show") }), !a.closest(".chat-list") || a.closest(".chat-list").classList.contains("left") ? n : "You");
        ...
        k = function(e, t) {
            ...
            }), a.querySelectorAll(".copy-message").forEach(function(e) { e.addEventListener("click", function() { a.childNodes[1].children[1].firstElementChild.firstElementChild.getAttribute("id"), isText = a.childNodes[1].children[1].firstElementChild.firstElementChild.innerText, navigator.clipboard.writeText(isText) }) })
        };
