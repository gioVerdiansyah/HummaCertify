...
<head>
    ...
    <body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-offset="20">
        ...
        <!-- Hero Start -->
        <section class="hero-6 bg-center position-relative overflow-hidden" style="background-image: url(images/hero-6-bg.png);" id="home">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-5">
                        <i class="mb-4 icon-lg sw-1_5 text-primary" data-feather="sunrise"></i>
                        <h1 class="font-weight-semibold mb-4 hero-6-title">Get Your Professional Website Done With <b>Qexal</b></h1>
                    ...
                    <div class="col-lg-6 col-sm-10 mx-auto ms-lg-auto me-lg-0">
                        <div class="mt-lg-0 mt-5">
                            <img src="images/hero-6-img.png" alt="" class="img-xl-responsive" />
                        </div>
                    </div>
                </div>
            </div>
