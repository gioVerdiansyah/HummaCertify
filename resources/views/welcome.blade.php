...
<!-- Mirrored from themesbrand.com/qexal/layout/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Oct 2023 07:16:43 GMT -->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-sm-10 mx-auto ms-lg-auto me-lg-0">
                    <div class="mt-lg-0 mt-5">
                        <img src="{{ asset('landingpage/images/image1.png') }}" alt=""
                    ...
                    <div class="service-box text-center px-4 py-5 position-relative mb-4">
                        <div class="service-box-content p-4">
                            <div class="icon-mono service-icon avatar-md mx-auto mb-4">
                                <svg width="72" height="73" viewBox="0 0 72 73" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect y="0.390137" width="72" height="72" rx="36" fill="#FBFBFB"/>
                                    <path d="M36 34.5C39.1562 34.5 41.7143 31.926 41.7143 28.75C41.7143 25.574 39.1562 23 36 23C32.8438 23 30.2857 25.574 30.2857 28.75C30.2857 31.926 32.8438 34.5 36 34.5ZM40.2768 35.9645L38.1429 44.5625L36.7143 38.4531L38.1429 35.9375H33.8571L35.2857 38.4531L33.8571 44.5625L31.7232 35.9645C28.5402 36.1172 26 38.7361 26 41.975V43.8438C26 45.0342 26.9598 46 28.1429 46H43.8571C45.0402 46 46 45.0342 46 43.8438V41.975C46 38.7361 43.4598 36.1172 40.2768 35.9645Z" fill="#29344A"/>
                                </svg>                                    
                            </div>
        ...
        <div class="container">
            ...
            <div class="row align-items-center mb-5">
                <div class="col-md-5 order-2 order-md-1 mt-md-0 mt-5">
                    <p class="text-muted mb-5">Sertifikat kelulusan magang adalah wujud pengakuan atas upaya dan dedikasi siswa magang yang telah menyelesaikan program mereka. Sertifikat khusus acara, di sisi lain, adalah bukti kehadiran atau kontribusi dalam acara-acara tertentu yang mungkin relevan dengan pengalaman magang.
                        <br><br>
                        Kami menghargai pentingnya sertifikat-sertifikat ini dalam perjalanan pendidikan dan karier siswa magang dan guru magang. Oleh karena itu, kami dengan sepenuh hati berkomitmen untuk membantu Anda memeriksa keaslian sertifikat-sertifikat ini melalui platform kami.
                    </p>
                </div>
                <!-- end col -->
            ...
            <div class="row align-items-center section pb-0">
                ...
                <div class="col-md-5 ms-md-auto">
                    <p class="text-muted mb-5">Dengan penggunaan platform kami, Anda dapat dengan mudah memastikan bahwa sertifikat kelulusan magang dan sertifikat khusus acara yang Anda miliki adalah resmi dan sah sesuai dengan ketentuan perusahaan kami.
                        <br><br>
                        Jadi, jika Anda adalah seorang siswa magang atau guru magang yang ingin memverifikasi sertifikat Anda, silakan manfaatkan platform kami dengan percaya diri. Kami siap membantu Anda dalam proses ini dan memastikan keaslian sertifikat-sertifikat tersebut. Terima kasih atas kepercayaan Anda kepada layanan kami.</p>
                </div>
                <!-- end col -->
            </div>
            <!-- end row -->
                    ...
                    <div class="card mt-4 border-0 shadow">
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex align-items-center mt-4 pt-2">
                                <img src="images/user/img-2.jpg" class="rounded-circle avatar-sm me-3"
                                    alt="..." />
                                <div class="flex-body">
                    ...
                    <div class="card mt-4 border-0 shadow">
                        <div class="card-body p-4">
                            ...
                            <p class="text-muted">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut
                                fugit.</p>
                            <div class="d-flex align-items-center mt-4 pt-2">
                                <img src="images/user/img-3.jpg" class="rounded-circle avatar-sm me-3"
                                    alt="..." />
                                <div class="flex-body">
                    ...
                    <div class="card mt-4 border-0 shadow">
                        <div class="card-body p-4">
                            ...
                            <p class="text-muted">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut
                                fugit.</p>
                            <div class="d-flex align-items-center mt-4 pt-2">
                                <img src="images/user/img-1.jpg" class="rounded-circle avatar-sm me-3"
                                    alt="..." />
                                <div class="flex-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-4 pb-2">
                                        ...
                                        <textarea name="comments" id="comments" rows="10" class="form-control" placeholder="Masukkan pesan..."></textarea>
                                    </div>

                                    <button type="submit" id="submit" name="send"
                                        class="btn bg-biru">Kirim Pesan</button>
                                </div>
                            </div>
                        </form>
                    </div>
