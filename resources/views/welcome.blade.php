...
<body data-bs-spy="scroll" data-bs-target="#site-navbar" class="home-freelancer">
    ...
    <!-- PRE LOADER -->
    <div class="js-preloader flex-center">
        {{-- <div class="dots">
      <div class="dot"></div>
      <div class="dot"></div>
      <div class="dot"></div>
  ...
  <section class="features-section section-block" id="features-section">
    <div class="container">
      <div class="row">
                ...
                <div class="col-xl-4 col-lg-6" data-aos="fade-up">
                    <div class="item-wrapper">
                        ...
                        <div class="content-wrapper">
                            <h3>Creativity</h3>
                            <p>
                                Duis aute irure dolor in it esse cillum dolore eu fugiat nulla pari erunt mollit anim id
                                est laborum.
                            </p>
                        </div> <!-- .content-wrapper -->
                    </div> <!-- .item-wrapper -->
        ...
        <div class="design-elements">
            <img class="de-intro-1 elem-updown"
                src="{{ asset('image-template-2/design-elements/intro-element-1.png') }}" alt="intro element 1">
        </div> <!-- .design-elements -->
    ...
    <section class="about-section section-block" id="about-section" data-aos="fade-up">
        ...
        <div class="design-elements">
            <img class="de-about-1 elem-updown"
                src="{{ asset('image-template-2/design-elements/about-element-1.png') }}" alt="about element 1">
            <img class="de-about-2 elem-updown"
                src="{{ asset('image-template-2/design-elements/about-element-2.png') }}" alt="about element 2">
        </div> <!-- .design-elements -->
    </section> <!-- .about-section -->
    ...
    <section class="portfolio-section section-block" id="portfolio-section">
        <div class="container">
            ...
            <div class="row grid" data-aos="fade-up" data-aos-duration="2000">
                <div class="col-lg-4 col-md-6 grid-item programming">
                    <div class="box">
                        <img src="{{ asset('image-template-2/portfolio/portfolio-item-01.jpgsets') }}"
                            alt="portfolio image">
                                        ...
                                        <div class="row item-content">
                                            ...
                                            <div class="col-xl-4">
                                                <div class="meta-wrapper">
                                                    <ul class="item-meta">
                                                        <li>Project Type: <span class="meta-value">Graphic
                                                                Design</span></li>
                ...
                <div class="col-lg-4 col-md-6 grid-item development application">
                    <div class="box">
                        <img src="{{ asset('image-template-2/portfolio/portfolio-item-02.jpg') }}"
                            alt="portfolio image">
                        <div class="box-content">
                ...
                <div class="col-lg-4 col-md-6 grid-item application programming design">
                    <div class="box">
                        <img src="{{ asset('image-template-2/portfolio/portfolio-item-03.jpg') }}"
                            alt="portfolio image">
                        <div class="box-content">
                ...
                <div class="col-lg-4 col-md-6 grid-item design application">
                    <div class="box">
                        <img src="{{ asset('image-template-2/portfolio/portfolio-item-04.jpg') }}"
                            alt="portfolio image">
                        <div class="box-content">
                ...
                <div class="col-lg-4 col-md-6 grid-item programming design">
                    <div class="box">
                        <img src="{{ asset('image-template-2/portfolio/portfolio-item-05.jpg') }}"
                            alt="portfolio image">
                        <div class="box-content">
                            <span class="category">Programming</span>
                ...
                <div class="col-lg-4 col-md-6 grid-item development design">
                    <div class="box">
                        <img src="{{ asset('image-template-2/portfolio/portfolio-item-06.jpg') }}"
                            alt="portfolio image">
                        <div class="box-content">
                            <span class="category">Development</span>
        ...
        <div class="design-elements">
            <img class="de-portfolio-1 elem-updown"
                src="{{ asset('image-template-2/design-elements/portfolio-element-1.png') }}"
                alt="portfolio element 1">
            <img class="de-portfolio-2 elem-updown"
                src="{{ asset('image-template-2/design-elements/portfolio-element-2.png') }}"
              ...
              <div class="modal-content">
                ...
                <div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="600">
                    <div class="content-wrapper service-tilt" data-tilt data-tilt-max="15">
                        ...
                        <p>
                            Det esse prehen pteur sint occaecat cupidat cillum dolore eu fugiat nulla kopa samsu kopa
                            kidye je tare
                    ...
                    <div class="testimonial-item swiper-slide">
                        <div class="item-wrapper">
                            ...
                            <div class="quote-author d-flex align-items-center justify-content-center">
                                <div class="image-block">
                                    <img class="img-fluid"
                                        src="{{ asset('image-template-2/testimonial/testimonial-author-1.jpg') }}"
                    ...
                    <div class="testimonial-item swiper-slide">
                        <div class="item-wrapper">
                            ...
                            <div class="quote-author d-flex align-items-center justify-content-center">
                                <div class="image-block">
                                    <img class="img-fluid"
                                        src="{{ asset('image-template-2/testimonial/testimonial-author-3.jpg') }}"
                                        alt="testimonial author">
                                </div>
                                <h4>Dona Josefine<span>Web Developer</span></h4>
                            </div>
                    ...
                    <div class="testimonial-item swiper-slide">
                        <div class="item-wrapper">
                            ...
                            <div class="quote-author d-flex align-items-center justify-content-center">
                                <div class="image-block">
                                    <img class="img-fluid"
                                        src="{{ asset('image-template-2/testimonial/testimonial-author-4.jpg') }}"
                                        alt="testimonial author">
                                </div>
                                <h4>Mark Anthony <span>Web Developer</span></h4>
                            </div>
                    ...
                    <div class="testimonial-item swiper-slide">
                        <div class="item-wrapper">
                            ...
                            <div class="quote-author d-flex align-items-center justify-content-center">
                                <div class="image-block">
                                    <img class="img-fluid"
                                        src="{{ asset('image-template-2/testimonial/testimonial-author-2.jpg') }}"
                                        alt="testimonial author">
                                </div>
                                <h4>Sanjida Ema<span>Web Developer</span></h4>
                            </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row blog-content">
                                        <div class="col-xl-12">
                                            <img class="img-fluid"
                                                src="{{ asset('image-template-2/blog/blog_full_01.jpg') }}"
                                        ...
                                        <div class="col-xl-8 offset-xl-2">
                                            <div class="content-wrapper">
                                                ...
                                                <p>
                                                    ...
                                                    blandit. Nulla vel varius
                                                    felis. Integer felis urna, auctor hendrerit ante vitae, scelerisque
                                                    bibendum quam. Proin
                                                    libero leo, pulvinar nec iaculis ac, sodales nec tellus. Sed ut
                                                    suscipit erat. Integer aliquam
                                                    erat eget hendrerit ultricies. In pharetra eu ante consequat
                                                    tincidunt. Curabitur vulputate
                                                    ligula risus, ac auctor magna vulputate sit amet. Sed finibus neque
                                                    neque, euismod porta felis
                                                    vehicula at. Donec a sem id augue sagittis tincidunt non sit amet
                                                    risus.
                                                </p>
                                                <p>
                                                    Duis aute irure dolor in reprehenderit in voluptate velit esse
                                                ...
                                                <p>
                                                    ...
                                                    fringilla ex. Nam id dui
                                                    dignissim, maximus ligula id, tempus metus. Sed commodo dui vitae
                                                    dui pulvinar, eu dignissim
                                                    turpis luctus. Mauris consectetur leo est, non finibus tellus
                                                    posuere quis. Integer mollis
                    ...
                    <div class="row">
                        <div class="col-md-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row blog-content">
                                                <div class="col-xl-12">
                                                    <img class="img-fluid"
                                                        src="{{ asset('image-template-2/blog/blog_full_03.jpg') }}"
                                                        alt="blog post image 02">
                                                </div>
                                                <div class="col-xl-8 offset-xl-2">
                                                    <div class="content-wrapper">
                                                        <h2 class="blog-title">Typescript algorythm and data structure
                                                            for beginner</h2>
                                                        <ul
                                                            class="blog-meta d-md-flex align-items-center justify-content-md-center">
                                                            <li><a href="#"><i class="bi bi-folder-fill"></i>
                                                        ...
                                                        <p>
                                                            ...
                                                            rhoncus blandit. Nulla vel
                                                            varius felis. Integer felis urna, auctor hendrerit ante
                                                            vitae, scelerisque bibendum quam.
                                                            Proin libero leo, pulvinar nec iaculis ac, sodales nec
                                                            tellus. Sed ut suscipit erat.
                                                            Integer aliquam erat eget hendrerit ultricies. In pharetra
                                                            eu ante consequat tincidunt.
                                                            Curabitur vulputate ligula risus, ac auctor magna vulputate
                                                            sit amet. Sed finibus neque
                                                            neque, euismod porta felis vehicula at. Donec a sem id augue
                                                            sagittis tincidunt non sit
                                                            amet risus.
                                                        </p>
                                                        <p>
                                                        ...
                                                        <p>
                                                            Vestibulum aliquet pulvinar neque sed ullamcorper. Ut vitae
                                                            fringilla ex. Nam id dui
                                                            dignissim, maximus ligula id, tempus metus. Sed commodo dui
                                                            vitae dui pulvinar, eu
                                                            dignissim turpis luctus. Mauris consectetur leo est, non
                                                            finibus tellus posuere quis.
                                                            Integer mollis felis a tristique facilisis. Nam convallis
                            ...
                            <div class="content-wrapper">
                                <div class="post-content">
                                    ...
                                    <h3><a href="#" data-bs-toggle="modal" data-bs-target="#blogModal2">Design
                                            a wesite using
                                            Figma easily</a></h3>
                                </div>
                                <div class="image-wrapper">
                                    <img class="img-fluid"
                                        src="{{ asset('image-template-2/blog/post-thumbnail-03.jpg') }}"
                                        alt="post thumnail">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="600">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row blog-content">
                                                <div class="col-xl-12">
                                                    <img class="img-fluid"
                                                        src="{{ asset('image-template-2/blog/blog_full_04.jpg') }}"
                                                        alt="blog post image 03">
                                                </div>
                                                <div class="col-xl-8 offset-xl-2">
                                                    <div class="content-wrapper">
                                                        <h2 class="blog-title">Javascript algorythm and data structure
                                                            for beginner</h2>
                                                        <ul
                                                            class="blog-meta d-md-flex align-items-center justify-content-md-center">
                                                            <li><a href="#"><i class="bi bi-folder-fill"></i>
                            ...
                            <div class="content-wrapper">
                                <div class="post-content">
                                    ...
                                    <h3><a href="#" data-bs-toggle="modal" data-bs-target="#blogModal3">Break
                                            on through to the
                                            other side</a></h3>
                                </div>
                                <div class="image-wrapper">
                                    <img class="img-fluid"
                                        src="{{ asset('image-template-2/blog/post-thumbnail-04.jpg') }}"
                                        alt="post thumnail">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="800">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row blog-content">
                                                <div class="col-xl-12">
                                                    <img class="img-fluid"
                                                        src="{{ asset('image-template-2/blog/blog_full_05.jpg') }}"
                            ...
                            <div class="content-wrapper">
                                ...
                                <div class="image-wrapper">
                                    <img class="img-fluid"
                                        src="{{ asset('image-template-2/blog/post-thumbnail-05.jpg') }}"
                                        alt="post thumnail">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="1000">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row blog-content">
                                                <div class="col-xl-12">
                                                    <img class="img-fluid"
                                                        src="{{ asset('image-template-2/blog/blog_full_06.jpg') }}"
                            ...
                            <div class="content-wrapper">
                                <div class="post-content">
                                    ...
                                    <h3><a href="#" data-bs-toggle="modal" data-bs-target="#blogModal5">When
                                            the musics over
                                            turn off the light</a></h3>
                                </div>
                                <div class="image-wrapper">
                                    <img class="img-fluid"
                                        src="{{ asset('image-template-2/blog/post-thumbnail-06.jpg') }}"
                                        alt="post thumnail">
                                </div>
                            </div>
                        </div>
    ...
    <div class="design-elements">
      ...
      <img class="de-blog-2 elem-updown" src="{{ asset('image-template-2/design-elements/blog-element-2.png') }}" alt="blog element 2">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 form-block" data-aos="fade-right" data-aos-duration="1500"
                    data-aos-delay="1100">
        ...
        <div class="design-elements">
            <img class="de-contact-1 elem-updown"
                src="{{ asset('image-template-2/design-elements/contact-element-1.png') }}"
                alt="contact element 1">
            <img class="de-contact-2 elem-updown"
                src="{{ asset('image-template-2/design-elements/contact-element-2.png') }}"
