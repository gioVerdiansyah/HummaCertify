      ...
      <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6 col-xl-5">
          <div class="form-bg shadow bg-white">
            <form method="POST" action="{{ route('password.email') }}" class="av-invalid">
              ...
              <div class="p-4 mobile-background">
                ...
                <div class="p-3">
                  <div class="mb-3">
                    <input name="email" required placeholder="Email" id="username" type="hidden" class="form-control" value="{{ $email }}" />
                  </div>
                  <div class="mb-3">
          ...
          <div class="text-center mt-4 bottom-text">
            <p>Email Salah? <a href="{{ route('password.request') }}" class="font-weight-semibold text-biru"> Kembali </a> </p>
          </div>
        </div>
        <!-- end col -->
      </div>
