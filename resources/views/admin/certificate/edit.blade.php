                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    placeholder="Masukkan nama" name="name" id="name"
                                    value="{{ old('name', $certificate->user->name) }}" required>
                                @error('name')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <input type="text"
                                    class="form-control @error('bidang')
                                @enderror"
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <input type="date" class="form-control" placeholder="dd/mm/yy" name="tanggal"
                                    id="tanggal" value="{{ old('tanggal', $certificate->tanggal) }}" required>
                            </div>
                            <div class="col-12 mb-4">
                                ...
                                @enderror"
                                    ...
                                    <option value="Sangat Baik"
                                        ...
                                        Sangat Baik</option>
                                    <option value="Baik"
                                        {{ old('predikat', $certificate->predikat) == 'Baik' ? 'selected' : '' }}>
                                        Baik
                                    </option>
                                    <option value="Cukup"
                                        {{ old('predikat', $certificate->predikat) == 'Cukup' ? 'selected' : '' }}>
                                        Cukup
                                    </option>
                                    <option value="Kurang"
                                        {{ old('predikat', $certificate->predikat) == 'Kurang' ? 'selected' : '' }}>
                                        Kurang
                                    </option>
                                </select>
                                @error('predikat')
                        ...
                        <div class="d-flex flex-row">
                            <div class="col-12 mb-4">
                                ...
                                @enderror"
                                    name="instruktur" id="instruktur"
                                    value="{{ old('instruktur', $certificate->instruktur) }}"
