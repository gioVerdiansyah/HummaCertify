                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Masukkan nama" name="name" id="name" value="{{ old('name', $certificate->user->name) }}">
                                    @error('name')
                            ...
                            <input type="text" class="form-control @error('nomor_induk') is-invalid  @enderror" placeholder="Masukkan NIS/NIM/NIP"
                                    name="nomor_induk" id="nomorInduk" value="{{ old('nomor_induk', $certificate->user->password) }}">
                                    @error('nomor_induk')
                                    <div class="invalid-feedback">
                                        <p>{{ $message }}</p>
                                    </div>
                            ...
                            <div class="col-12 mb-4">
                                ...
                                @enderror" placeholder="Email peserta" name="email"
                                    id="email" value="{{ old('email', $certificate->user->email) }}">
                                    @error('email')
                                    <div class="invalid-feedback">
                                        <p>{{ $message }}</p>
                                    </div>
                            ...
                            <div class="col-12 mb-4">
                                ...
                                @enderror" placeholder="Tempat dan tanggal lahir peserta"
                                    name="ttl" id="ttl" value="{{ old('ttl', $certificate->user->ttl) }}">
                                    @error('ttl')
                                        <div class="invalid-feedback">
                                            <p>{{ $message }}</p>
                                        </div>
                            ...
                            <div class="col-12 mb-4">
                                ...
                                @enderror" placeholder="Asal institusi" name="institusi"
                                    id="institusi" value="{{ old('institusi', $certificate->user->institusi) }}">
                                    @error('institusi')
                                    <div class="invalid-feedback">
                                        <p>{{ $message }}</p>
                                    </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-12 mb-4 mt-3">
                                ...
                                @enderror">
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}" {{ old('certificate_categori_id', $certificate->certificate_categori_id) == $category->id ? 'selected' : '' }}>{{ $category->name }}</option>
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <input type="date" class="form-control" placeholder="dd/mm/yy" name="tanggal"
                                    id="tanggal" value="{{ old('tanggal', $certificate->tanggal) }}">
                            </div>
                            <div class="col-12 mb-4">
                               ...
                               <select name="predikat" class="form-select @error('predikat') is-invalid
                                ...
                                @enderror
                                    ...
                                    <option value="Kurang" {{ old('predikat', $certificate->predikat) == 'Kurang' ? 'selected' : '' }}>Kurang
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-row">
                            <div class="col-12 mb-4">
                                ...
                                @enderror" name="instruktur" id="instruktur" value="{{ old('instruktur', $certificate->instruktur) }}">
