                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <input required type="text" class="form-control @error('name') is-invalid @enderror"
                                    placeholder="Masukkan nama" name="name" id="name" value="{{ old('name') }}"
                                    required>
                                @error('name')
                            ...
                            <div class="col-12">
                                ...
                                @if (!old('email') && !$errors->has('email'))
                                    <p class="text-warning" style="margin-bottom: 3px;"><i
                                            class="bi bi-exclamation-circle"></i> Jika tidak
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-12 mb-4">
                                ...
                                @enderror"
                                    placeholder="dd/mm/yy" name="tanggal" id="tanggal" value="{{ old('tanggal') }}"
                                    required>
                                @error('tanggal')
                                    <div class="invalid-feedback">
                                        <p>{{ $message }}</p>
                        ...
                        <div class="d-flex flex-row">
                            <div class="col-12 mb-4">
                                ...
                                @enderror"
                                    name="instruktur" placeholder="Nama instruktur" id="instruktur"
                            ...
                            <div class="card-body">
                                <div class="repeater">
                                                    ...
                                                    <div class="d-flex flex-row">
                                                        <div class="col-6 mb-4 pe-3">
                                                            ...
                                                            <input required type="text"
                                                                ...
                                                                value="{{ $category['materi'] }}" required>
                                                    ...
                                                    <div class="d-flex flex-row">
                                                        <div class="col-6 mb-4 pe-3">
                                                            ...
                                                            <input required type="text" class="form-control"
                                                                placeholder="materi" name="materi" value=""
                                                                required>
                                                        </div>
                                                        <div class="col-6 mb-4 ps-2">
                                                            <label for="unknown" class="form-label">Jam
                                                            ...
                                                            <div class="d-flex flex-row">
                                                                <input required type="number" name="jam_pelajaran"
                                                                    class="form-control" id="jamPelajaran"
                                    ...
                                    <div class="hstack gap-2 justify-content-end">
                                        <input required class="btn btn-outline-success waves-effect waves-light"
                                            data-repeater-create type="button" value="+ Tambah" />
                                    </div>
                                </div>
                            </div>
