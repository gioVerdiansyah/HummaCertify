          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="col-12 mb-4">
                ...
                <input type="text" class="form-control @error('nomor_induk') is-invalid  @enderror" placeholder="Masukkan NIS/NIM/NIP" name="nomor_induk" id="nomorInduk" value="{{ old('nomor_induk') }}">
                @error('nomor_induk')
                  <div class="invalid-feedback">
                    <p>{{ $message }}</p>
                  </div>
              ...
              <div class="col-12">
                ...
                <input type="text" class="form-control @error('email') is-invalid
                                @enderror" placeholder="Email peserta" name="email" id="email" value="{{ old('email') }}">
              ...
              <div class="col-12 mb-4">
                ...
                <input type="text" class="form-control @error('ttl') is-invalid
                                @enderror" placeholder="Tempat dan tanggal lahir peserta" name="ttl" id="ttl" value="{{ old('ttl') }}">
                @error('ttl')
                  <div class="invalid-feedback">
                    <p>{{ $message }}</p>
                  </div>
              ...
              <div class="col-12 mb-4">
                ...
                <input type="text" class="form-control @error('institusi') is-invalid
                                @enderror" placeholder="Asal institusi" name="institusi" id="institusi" value="{{ old('institusi') }}">
                @error('institusi')
                  <div class="invalid-feedback">
                    <p>{{ $message }}</p>
                  </div>
            ...
            <div class="col-md-6">
              ...
              <div class="col-12 mb-4">
                ...
                <input type="text" class="form-control @error('bidang') is-invalid
                                @enderror" placeholder="Bidang yang diikuti peserta" id="bidang" name="bidang" value="{{ old('bidang') }}">
                @error('bidang')
                  <div class="invalid-feedback">
                    <p>{{ $message }}</p>
                  </div>
              ...
              <div class="col-12 mb-4">
                ...
                <input type="text" class="form-control @error('sub_bidang') is-invalid
                                @enderror" placeholder="Sub bidang peserta" id="subBidang" name="sub_bidang" value="{{ old('sub_bidang') }}">
                @error('sub_bidang')
                  <div class="invalid-feedback">
                    <p>{{ $message }}</p>
                  </div>
              ...
              <div class="col-12 mb-4">
                ...
                <input type="date" class="form-control @error('tanggal') is-invalid
                                @enderror" placeholder="dd/mm/yy" name="tanggal" id="tanggal" value="{{ old('tanggal') }}">
                @error('tanggal')
                  <div class="invalid-feedback">
                    <p>{{ $message }}</p>
                  </div>
                        ...
                        <div class="d-flex flex-row">
                          <div class="col-6 mb-4 pe-3">
                            ...
                            <input type="text" class="form-control @error('category-group.*.materi') is-invalid
                                                        @enderror" placeholder="materi" name="materi" value="">
                          ...
                          <div class="col-6 mb-4 ps-2">
                            ...
                            <div class="d-flex flex-row">
                              <input type="number" name="jam_pelajaran" class="form-control @error('jam_pelajaran') is-invalid
                                                            @enderror" id="jamPelajaran" placeholder="Jam Pelajaran">
                              @error('jam_pelajaran')
                                <div class="invalid-feedback">
                                  <p>{{ $message }}</p>
                                </div>
