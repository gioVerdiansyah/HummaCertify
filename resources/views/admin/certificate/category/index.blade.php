...
@section('content')
    ...
    <div class="col-2 mb-4">
        <a href="{{ route('category.create') }}" class="btn btn-primary m-0 d-flex gap-1">Tambah Kategori <i
                class="ri-add-line d-flex align-items-center"></i></a>
    </div>
    <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <a href="javascript: void(0);" class="image-container">
                            <img src="{{ asset("image/bgdepan/" . $category->background_depan) }}" class="ukuran gmr" alt="Background {{ $category->name }}">
