                    ...
                    <div class="body-card">
                        <div class="mb-3">
                            ...
                            <input type="text" name="namaKategori"
                                class="form-control @error('namaKategori') is-invalid @enderror" placeholder="Nama kategori"
                                value="{{ old('namaKategori', $category->name) }}" required>
                            @error('namaKategori')
                        ...
                        <div class="mb-3">
                            ...
                            <select name="tataletak" id="tataLetak"
                                class="form-select @error('tataletak') is-invalid @enderror" required>
