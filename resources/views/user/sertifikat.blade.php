      ...
      <div class="content-main">
        <div class="content-item">
          <div class="tabs">
            ...
            <ul>
              <li title="Semua Sertifikat"><label for="tab1" role="button"><svg xmlns="http://www.w3.org/2000/svg"
                    width="36" height="36" viewBox="0 0 24 24"
                    style="fill: rgba(131, 131, 131, 1);transform: ;msFilter:;">
                    <path
                      d="M10 3H4a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1zM9 9H5V5h4v4zm11-6h-6a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1zm-1 6h-4V5h4v4zm-9 4H4a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1zm-1 6H5v-4h4v4zm8-6c-2.206 0-4 1.794-4 4s1.794 4 4 4 4-1.794 4-4-1.794-4-4-4zm0 6c-1.103 0-2-.897-2-2s.897-2 2-2 2 .897 2 2-.897 2-2 2z">
                    </path>
                  </svg><br><span>Semua</span></label></li>
              <li title="Sertifikat Kelulusan Magang"><label for="tab2" role="button"><svg
              ...
              <li title="Sertifikat Kompetensi"><label for="tab3" role="button"><svg
                    xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor"
                    style="fill: rgba(131, 131, 131, 1);transform: ;msFilter:; class="bi bi-person-gear"
                    viewBox="0 0 16 16">
                    <path
              ...
              <li title="Sertifikat Pelatihan"><label for="tab4" role="button"><svg
                    xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24"
                    style="fill: rgba(131, 131, 131, 1);transform: ;msFilter:;">
                    <path
              ...
              <section>
                ...
                <div class="row">
                    ...
                    @if ($certificate->certificate_categori_id === 1)
                      <div class="col-md-4 mb-4">
                        <a href="javascript: void(0);" class="image-container" id="certificate-container">
                          ...
                          <div class="image-hover-kelulusan-{{ $certificate->id }}"
                  ...
                  @if ($certificates->where('certificate_categori_id', 1)->isEmpty())
                    <p class="text-center">Anda tidak memiliki sertifikat kelulusan...</p>
                  @endif
                </div>
              </section>
              <section>
                ...
                <div class="row">
                    ...
                    @if ($certificate->certificate_categori_id === 2)
                      <div class="col-md-4 mb-4">
                        <a href="javascript: void(0);" class="image-container" id="certificate-container">
                          ...
                          <div class="image-hover-kompetensi-{{ $certificate->id }}"
                            onclick="openModal('{{ $certificate->id }}')">
                            <h1 class="hover-animate">Klik untuk melihat ukuran penuh</h1>
                          </div>
                        </a>
                  ...
                  @if ($certificates->where('certificate_categori_id', 2)->isEmpty())
                    <p class="text-center">Anda tidak memiliki sertifikat Kompetensi...</p>
                  @endif
                </div>
              </section>
              <section>
                ...
                <div class="row">
                    ...
                    @if ($certificate->certificate_categori_id === 3)
                      <div class="col-md-4 mb-4">
                        <a href="javascript: void(0);" class="image-container" id="certificate-container">
                          ...
                          <div class="image-hover-pelatihan-{{ $certificate->id }}"
                            onclick="openModal('{{ $certificate->id }}')">
                            <h1 class="hover-animate">Klik untuk melihat ukuran penuh</h1>
                          </div>
                        </a>
                  ...
                  @if ($certificates->where('certificate_categori_id', 3)->isEmpty())
                    <p class="text-center">Anda tidak memiliki sertifikat Pelatihan...</p>
                  @endif
                </div>
              </section>
            </div>
