        ...
        <div class="content-item">
          <div class="tabs">
            ...
            <ul>
              ...
              <li title="Sertifikat Kelulusan Magang"><label for="tab2" role="button"><svg xmlns="http://www.w3.org/2000/svg"
                    width="36" height="36" viewBox="0 0 24 24"
                    style="fill: rgba(131, 131, 131, 1);transform: ;msFilter:;">
              ...
              <li title="Sertifikat Kompetensi"><label for="tab3" role="button"><svg xmlns="http://www.w3.org/2000/svg"
              ...
              <li title="Sertifikat Pelatihan"><label for="tab4" role="button"><svg xmlns="http://www.w3.org/2000/svg"
                    width="36" height="36" viewBox="0 0 24 24"
                    style="fill: rgba(131, 131, 131, 1);transform: ;msFilter:;">
                    <path
